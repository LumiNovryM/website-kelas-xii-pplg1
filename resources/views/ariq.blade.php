...
<html lang="en">
	<head>
		...
		<!-- animate -->
		<link rel="stylesheet" href="/ariq/style/animate.min.css">
		<!-- bootstrap -->
		<link rel="stylesheet" href="/ariq/style/bootstrap.min.css">
		<!-- font-awesome -->
		<link rel="stylesheet" href="/ariq/style/font-awesome.min.css">
		<!-- google font -->
		<link href='http://fonts.googleapis.com/css?family=Raleway:400,300,700,800' rel='stylesheet' type='text/css'>
		<!-- fullpage -->
		<link rel="stylesheet" href="/ariq/style/jquery.fullPage.css">
		<!-- custom -->
		<link rel="stylesheet" href="/ariq/style/templatemo-style.css">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-8 wow fadeIn" data-wow-delay="0.9s">
						<h3>Welcome</h3>
						<h1>Ariq</h1>
						<h2 class="rotate">DESIGNER &AMP; DEVELOPER, UI &AMP; UX SPECIALIST</h2>
						<p>School at Vocational School of SMK TARUNA BHAKTI DEPOK</p>
				...
				<div class="row">
					...
					<div class="col-md-6 col-xs-11 wow fadeInRight" data-wow-delay="0.9s">
						<span class="text-top">Web Design <small>82%</small></span>
							<div class="progress">
								<div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 82%;"></div>
							</div>
						<span>Mobile Apps <small>40%</small></span>
							<div class="progress">
						...
						<span>SEO Stuffs <small>1%</small></span>
							<div class="progress">
						...
						<span>HTLM5 &AMP; CSS3 <small>62%</small></span>
							<div class="progress">
								<div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 62%;"></div>
							</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-4 col-xs-6 wow fadeIn" data-wow-delay="0.6s">
					<div class="portfolio-thumb">
						<img src="/ariq/images/portfolio-img1.jpg" class="img-responsive" alt="portfolio img">
				...
				<div class="col-md-4 col-xs-6 wow fadeIn" data-wow-delay="0.6s">
					<div class="portfolio-thumb">
						<img src="/ariq/images/portfolio-img2.jpg" class="img-responsive" alt="portfolio img">
							<div class="portfolio-overlay">
								<h4>Web App</h4>
								<h5>Author: Linda</h5>
							</div>
				...
				<div class="col-md-4 col-xs-6 wow fadeIn" data-wow-delay="0.6s">
					<div class="portfolio-thumb">
						<img src="/ariq/images/portfolio-img3.jpg" class="img-responsive" alt="portfolio img">
							<div class="portfolio-overlay">
								<h4>Mobile App</h4>
								<h5>Author: Kate</h5>
							</div>
				...
				<div class="col-md-6 col-xs-6 wow fadeIn" data-wow-delay="0.6s">
					<div class="portfolio-thumb">
						<img src="/ariq/images/portfolio-img4.jpg" class="img-responsive" alt="portfolio img">
							<div class="portfolio-overlay">
								<h4>Old Artwork</h4>
				...
				<div class="col-md-6 col-xs-6 wow fadeIn" data-wow-delay="0.6s">
					<div class="portfolio-thumb">
						<img src="/ariq/images/portfolio-img5.jpg" class="img-responsive" alt="portfolio img">
							<div class="portfolio-overlay">
								<h4>New Animation</h4>
								<h5>Author: Kathy</h5>
							</div>
	...
	<!-- end portfolio -->
		...
		<!-- jQuery -->
		<script src="/ariq/js/jquery.js"></script>
		<!-- bootstrap -->
		<script src="/ariq/js/bootstrap.min.js"></script>
		<!-- fullpage -->
		<script src="/ariq/js/jquery.fullPage.js"></script>
		<!-- smoothScroll -->
		<script src="/ariq/js/smoothscroll.js"></script>
		<!-- wow -->
		<script src="/ariq/js/wow.min.js"></script>
		<!-- text rotater -->
		<script src="/ariq/js/jquery.simple-text-rotator.js"></script>
		<!-- custom -->
		<script src="/ariq/js/custom.js"></script>
