...
<html>
	...
	<title>M Rizky Hidayatulloh Fortfolio</title>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="colorlib-navbar-brand">
							<a class="colorlib-logo" href="index.html"><span>Ri</span><span>zky</span></a>
						</div>
		...
		<div id="colorlib-about">
			<div class="container">
				<div class="row text-center">
					<h2 class="bold">
<img src="https://w.wallhaven.cc/full/4o/wallhaven-4o53jm.jpg" alt="">
					</h2>
				</div>
				<div class="row">
					...
					<div class="col-md-6 col-md-push-1 animate-box">
						<div class="about-desc">
							<div class="owl-carousel3">
								<div class="item">
									<h2><span>M Rizky</span><span>Hidayatulloh</span></h2>
								</div>
								<div class="item">
							...
							<div class="desc">
								...
								<p class="teks" Introduce My Name M Rizky Hidayatulloh <a href="#">Born In Depok 13 October 2005</a> The First Child of 2 brothers And I Study At TARUNA BHAKTI VOCATIONAL HIGH SCHOOL DEPOK Taking Study Program or Department of Software Engineering</p>
							...
							<div class="one-third">
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<div class="services animate-box">
											<h3>3 - Front End Development & Back End Development</h3>
											<ul>
												<li>HTML / CSS</li>
												<li>JS </li>
												<li>PHP</li>
						...
						<div class="col-md-4 col-pb-sm">
							<div class="row">
								<div class="col-md-10">
									...
									<p><a href="#">rizkiyono10@gmail.com</a></p>
									<p class="colorlib-social-icons">
										<a href="#"><i class="icon-facebook4"></i></a>
										<a href="#"><i class="icon-twitter3"></i></a>
										<a href="#"><i class="icon-googleplus"></i></a>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart4" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank"> M Rizky Hidayatulloh</a>
